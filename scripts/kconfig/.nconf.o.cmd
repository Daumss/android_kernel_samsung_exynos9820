cmd_scripts/kconfig/nconf.o := gcc -Wp,-MD,scripts/kconfig/.nconf.o.d -Wall -Wmissing-prototypes -O2 -fomit-frame-pointer -std=gnu89    -DNCURSES_WIDECHAR -I/data/data/com.termux/files/usr/include -DCURSES_LOC="<ncurses.h>" -DNCURSES_WIDECHAR=1 -DLOCALE   -c -o scripts/kconfig/nconf.o scripts/kconfig/nconf.c
...
deps_scripts/kconfig/nconf.o := \
  ...
  /data/data/com.termux/files/usr/bin/../../usr/include/menu.h \
  /data/data/com.termux/files/usr/bin/../../usr/include/eti.h \
  /data/data/com.termux/files/usr/bin/../../usr/include/panel.h \
  /data/data/com.termux/files/usr/bin/../../usr/include/form.h \
